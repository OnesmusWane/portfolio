...
import { CodeIcon, ServerIcon, DatabaseIcon, CloudIcon, LayoutIcon, TerminalIcon, GitBranchIcon, SettingsIcon } from 'lucide-react';
export function Skills() {
  const frontendSkills = ['React', 'TypeScript', 'JavaScript', 'HTML5', 'CSS3', 'Redux', 'Next.js', 'Tailwind CSS', 'Material UI', 'Framer Motion'];
  const backendSkills = ['Node.js', 'Express', 'GraphQL', 'REST API', 'Authentication', 'Authorization', 'Microservices', 'WebSockets', 'API Design'];
  const databaseSkills = ['PostgreSQL', 'MongoDB', 'MySQL', 'Redis', 'Firebase', 'Prisma', 'Mongoose', 'SQL', 'NoSQL', 'Data Modeling'];
  const cloudSkills = ['AWS', 'Azure', 'Google Cloud', 'Vercel', 'Netlify', 'Docker', 'Kubernetes', 'CI/CD', 'DevOps', 'Serverless'];
  const SkillCategory = ({
    title,
    skills,
    icon
  ...
  return <section id="skills" className="py-20 bg-gray-50 dark:bg-gray-900">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <SkillCategory title="Cloud & DevOps" skills={cloudSkills} icon={<CloudIcon className="text-indigo-600 dark:text-indigo-400" size={24} />} />
        </div>
